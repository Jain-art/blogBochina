...
using blogBochina.Security;
using blogBochina.Domain.DB;
using blogBochina.Model.Common;

namespace blogBochina.Infrastructure.Guarantors
{
    /// <summary>
    ...
    public class SeedDataGuarantor
    {
        ...
        public async Task EnsureAsync()
        {
            ...
            var adminUser = userManager.FindByNameAsync(SecurityConstants.AdminUserRole).Result;
            if (adminUser == null)
            {
                ...
                adminUser = new User
                {
                    ...
                    UserName = SecurityConstants.AdminUserRole,
                    Employee = profile
                };
        ...
        private static async Task AssertRoleExistenceAsync(RoleManager<IdentityRole<int>> roleManager, BlogDbContext context)
        {
            var roles = new List<IdentityRole<int>>
            {
                ...
                new IdentityRole<int> { Name = SecurityConstants.CostomerRoel, NormalizedName = "CUSTOMER" }
            };
